...
import 'package:she/AccessLocation.dart';
import 'package:she/Callpolice.dart';
import 'package:permission_handler/permission_handler.dart';

class AccessMicroph extends StatelessWidget {
  const AccessMicroph({Key? key});
      ...
      children: [
        ...
        AlertDialog(
          content: Column(
            ...
            children: [
              Image.asset(
                'assets/microphone2.png', // Provide correct image path
                width: 50,
                height: 50,
              ),
              const SizedBox(height: 10),
              const Text('Allow SheSafe to access your microphone '),
            ],
          ),
          actions: [
            TextButton(
              onPressed: () {
                give_pemission(context);
              },
              child: const Text(
                'Access',
  ...
  Future<void> give_pemission(BuildContext context) async {
    var microphoneStatus = await Permission.microphone.request();

    if (microphoneStatus.isGranted) {
      Fluttertoast.showToast(
        msg: "Microphone permission recieved.",
      ...
      Future.delayed(Duration(milliseconds: 500), () {
        Navigator.of(context).pushAndRemoveUntil(
          MaterialPageRoute(builder: (context) => AccessLocation()),
  ...
  void not_give_pemission(BuildContext context) {
    Future.delayed(Duration(milliseconds: 500), () {
      Navigator.of(context).pushAndRemoveUntil(
        MaterialPageRoute(builder: (context) => AccessLocation()),
        (Route<dynamic> route) => false,
